...
{
    /// <summary> Clase para transportar datos sobre un empleado. </summary>
    public class Empleado
    {
        /// <summary> The identifier empleado </summary>
        private int id_empleado;

        /// <summary> The nombre </summary>
        private String nombre;

        /// <summary> The apellido paterno </summary>
        private String a_paterno;

        /// <summary> The apellido materno </summary>
        private String a_materno;

        /// <summary> The telefono </summary>
        private long telefono;

        /// <summary> The sueldo </summary>
        private double sueldo;

        /// <summary> The tipo empleado </summary>
        private String tipo_empleado;

        /// <summary> The clave </summary>
        private String clave;

        /// <summary> The usuario </summary>
        private String usuario;

        /// <summary> Initializes a new instance of the <see cref="Empleado"/> class. </summary>
        public Empleado()
        {
        }
        ...
        /// <summary> Gets or sets apellido paterno. </summary>
        /// <value> apellido paterno. </value>
        public string A_paterno { get => this.a_paterno; set => this.a_paterno = value; }

        /// <summary> Gets or sets apellido materno. </summary>
        /// <value> a materno. </value>
